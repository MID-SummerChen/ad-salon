...
export default {
  ...
  actions: {
    ...
    getHairLenList: async (store, data) => await apiInit(store, "POST", "form", `getHLength.php`, data),
    getHairColorList: async (store, data) => await apiInit(store, "POST", "form", `getHColor.php`, data),
    getHairStyleList: async (store, data) => await apiInit(store, "POST", "form", `getStyle.php`, data),
